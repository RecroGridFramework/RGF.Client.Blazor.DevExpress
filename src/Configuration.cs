...
public static class Configuration
{
    ...
    public static async Task LoadResourcesAsync(IJSRuntime jsRuntime, string themeName)
    {
        ...
        await jsRuntime.InvokeVoidAsync("Recrovit.LPUtils.AddStyleSheetLink", $"{RgfClientConfiguration.AppRootUrl}_content/DevExpress.Blazor.Themes/{themeName}.min.css", false, "devexpress-theme", $"{Assembly.GetEntryAssembly()?.GetName().Name}.styles.css");
        await jsRuntime.InvokeVoidAsync("Recrovit.LPUtils.AddStyleSheetLink", DevExtreme, true, "devextreme", "DevExpress.Blazor.Themes");
        await jsRuntime.InvokeVoidAsync("import", $"{RgfClientConfiguration.AppRootUrl}_content/{libName}/scripts/recrovit-rgf-blazor-devexpress.js");
    }
